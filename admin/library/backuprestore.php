...
class MiwoeventsBackupRestore {
    ...
    public function _copyImages($dir, $image_name) {
        foreach (glob($dir . "*") as $filename) {
			...
			$media_path = 'wp-content/miwi/media/miwoevents/images/';
    ...
    public function _copyFiles($dir) {
        foreach (glob($dir . "*") as $filename) {
            ...
            if (!MFile::copy($filename, MPATH_SITE . '/wp-content/miwi/media/miwoevents/images/' . basename($filename))){
                echo 'Failed to copy <i>' . $filename . '</i> to image directory.<br />';
            }

            if (!MFile::copy($filename, MPATH_SITE . '/wp-content/miwi/media/miwoevents/images/thumbs/' . basename($filename))){
                echo 'Failed to copy <i>' . $filename . '</i> to image directory.<br />';
            }
        }
    }
