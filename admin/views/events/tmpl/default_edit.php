...
<?php /*** ####### Wordpress Remove 3 line (JavaScript file)
	 */
...
<form action="<?php echo MRoute::getActiveUrl(); ?>" method="post" name="adminForm" id="adminForm" enctype="multipart/form-data" class="form form-horizontal">
	...
	<fieldset class="adminform">
		...
		<table class="admintable" width="100%">
			<tr>
				<td class="key2">
                    <span class="editlinktip hasTip" title="<?php echo MText::_('COM_MIWOEVENTS_NOTIFICATION_EMAILS' );?>::<?php echo MText::_('COM_MIWOEVENTS_NOTIFICATION_EMAIL_EXPLAIN'); ?>"><?php echo MText::_('COM_MIWOEVENTS_NOTIFICATION_EMAILS'); ?></span>
				</td>
				<td class="value2">
			...
			<tr>
				<td class="key2">
					<?php echo  MText::_('COM_MIWOEVENTS_REGISTRANT_EMAIL_BODY'); ?>
                    <div style="float:left; padding-top: 25px; padding-bottom: 10px;">
                        <?php echo MText::_('COM_MIWOEVENTS_AVAILABLE_TAGS'); ?>:<br/>[REGISTRATION_DETAIL], [FIRST_NAME], [LAST_NAME], [ORGANIZATION], [ADDRESS], [ADDRESS2], [CITY], [ZIP], [COUNTRY], [PHONE], [FAX], [EMAIL], [EVENT_DATE]
                    </div>
				</td>
				<td class="value2">
					<?php echo $editor->display('registrant_email_body', $this->item->registrant_email_body, '100%', '180', '90', '10' ) ; ?>
				</td>
			</tr>

			<tr>
				<td class="key2">
					<?php echo  MText::_('COM_MIWOEVENTS_THANKYOU_MESSAGE'); ?>
				</td>
				<td class="value2">
			...
			<tr>
				<td class="key2">
					<?php echo  MText::_('COM_MIWOEVENTS_REGISTRATION_APPROVED_EMAIL_BODY'); ?>
				</td>
				<td class="value2">
    ...
    <!-- Publishing -->
    <?php echo MHtml::_('tabs.panel', MText::_('COM_MIWOEVENTS_PUBLISHING_OPTIONS'), 'sl_publishing'); ?>
    <table class="admintable" width="100%">
    ...
    <!-- Dates -->
    <?php echo MHtml::_('tabs.panel', MText::_('COM_MIWOEVENTS_EVENTS_SL_DATES_TITLE'), 'sl_dates'); ?>
	...
	<?php if (@$this->MiwoeventsConfig->activate_recurring_event) {
			echo MHtml::_('tabs.panel', MText::_('COM_MIWOEVENTS_SL_RECURRING_OPTIONS'), 'sl_recurring'); ?>
	<table class="admintable" width="100%">
	<tr>
        <td class="key2">
    ...
    <!-- Registration -->
    <?php echo MHtml::_('tabs.panel', MText::_('COM_MIWOEVENTS_EVENTS_SL_REGISTRATION_TITLE'), 'sl_registration'); ?>
    <table class="admintable" width="100%">
        <tr>
        ...
        <tr>
            ...
            <tr>
                ...
                <td class="value2">
					<input type="text" name="currency_symbol" id="currency_symbol" class="inputbox" size="10" value="<?php echo $this->MiwoeventsConfig->currency_symbol; ?>" />
                </td>
            </tr>
		...
		<?php if (@$this->MiwoeventsConfig->version_select_control == "booking2") { ?>
        <tr>
            <td class="key2">
    ...
    <!-- Discount Settings -->
	<?php echo MHtml::_('tabs.panel', MText::_('COM_MIWOEVENTS_SL_DISCOUNTS'), 'sl_discount'); ?>
	<table class="admintable" width="100%">
		<tr>
            <td class="key2">
    ...
    <!-- Individual Fields -->
    <?php echo MHtml::_('tabs.panel', MText::_('COM_MIWOEVENTS_EVENTS_SL_IF_TITLE'), 'sl_bf'); ?>
    <table class="admintable" width="100%">
        <?php
        $varCount = count($this->ifNames["name"]);
        for ($i = 0; $i < $varCount; $i++) {
			$WIFTitle = $this->ifNames["title"][$i];
			$WIFName  = $this->ifNames["name"][$i];
		# Don't show Password field
		if ($this->ifNames["name"][$i] == "if_miwi_password") {
			continue;
		}
        ?>
    ...
    <!-- Group Fields -->
    <?php echo MHtml::_('tabs.panel', MText::_('COM_MIWOEVENTS_EVENTS_SL_GM_TITLE'), 'sl_gmf'); ?>
    <table class="admintable" width="100%">
        <?php
        $varCount = count($this->gfNames["name"]);

        for ($i = 0; $i < $varCount; $i++) {
			$WGFTitle = $this->gfNames["title"][$i];
			$WGFName  = $this->gfNames["name"][$i];
		# Don't show Password field
		if ($this->gfNames["name"][$i] == "gf_miwi_password") {
			continue;
		}
        ?>
        <tr>
    ...
    <!-- Reminder -->
    <?php echo MHtml::_('tabs.panel', MText::_('COM_MIWOEVENTS_EVENTS_SL_REMINDER_TITLE'), 'sl_reminder'); ?>
    <table class="admintable" width="100%">
    <tr>
        <td class="key2">
            <?php echo MText::_( 'COM_MIWOEVENTS_AUTO_REMINDER'); ?>
        </td>
        <td>
    ...
    <tr>
        <td class="key2">
            <?php echo MText::_( 'COM_MIWOEVENTS_REMIND_BEFORE'); ?>
        </td>
        <td class="value2">
	...
	<tr>
		...
		<td class="value2">
			...
			<input class="hide" type="text" name="edit_product_id" id="edit_product_id" size="1" readonly="readonly" value="0" />
		</td>
	</tr>
	</table>
