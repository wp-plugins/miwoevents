...
<form action="<?php echo MRoute::_('admin.php?page=miwoevents&option=com_miwoevents&view=config'); ?>" id="component-form" method="post" name="adminForm" autocomplete="off" class="form-validate form-horizontal">
