...
class MiwoeventsControllerCategory extends MiwoEventsController {
    ...
    public function save() {
        ...
        $_lang->load('com_miwoevents', MPATH_ADMINISTRATOR, null, true);
   		...
   		if ($this->_model->store($post)) {
   			$msg = MText::_('COM_MIWOEVENTS_CATEGORY_SAVED');
   		}
           else {
   			$msg = MText::_('COM_MIWOEVENTS_CATEGORY_SAVE_ERROR');
   		}
