...
/**
 * MDocumentRenderer_RSS is a feed that implements RSS 2.0 Specification
 *
 * @package     Moomla.Platform
 * @subpackage  Document
 ...
 * @since       11.1
 */
class MDocumentRendererRSS extends MDocumentRenderer
{
	/**
	 * Renderer mime type
	 *
	...
	public function render($name = '', $params = null, $content = null)
	{
		...
		$syndicationURL = MRoute::_('&format=feed&type=rss');
		...
		if ($data->pubDate != "")
		{
			$pubDate = MFactory::getDate($data->pubDate);
